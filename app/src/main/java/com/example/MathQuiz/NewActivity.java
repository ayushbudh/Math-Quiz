...
public class NewActivity extends AppCompatActivity {
    TextView timertext,winmsg, scorecard, question, rounds;
    ...
    public void gameOver(){
        ...
        scorecard.setText("Your Score:"+ String.format("%.02f",((float) userWin/totalRound)*100)+"%");
        userWin=0;
        totalRound=0;
    ...
    public void newGame(){
        ...
        // setting that values for incorrect options
